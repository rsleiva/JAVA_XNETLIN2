...
//    DIRECTORIOS RELATIVOS PARA PRODUCCION
    private static String base= "/ias/CallCenter_ENRE/";    
    ...
    private static String ConnDev = "jdbc:oracle:thin:NEXUS_ENRE/NEXUS_ENRE@tdbs6.tro.edenor:1521/GISDEV01";
    private static String ConnQA = "jdbc:oracle:thin:NEXUS_ENRE/NEXUS_ENRE@TDBS5.PRO.EDENOR:1529/GISQA01";
    private static String ConnPro = "jdbc:oracle:thin:NEXUS_ENRE/cami0net4@TCLH1.TRO.EDENOR:1528/GISPR01";
    //Literales
...
////////////////////////////////////////////////////////////////////////////////
    public static void main(String[] args) throws IOException {
        ...
        try {
            findPropiedades();
            if (base==null) {
                Log.log(Level.SEVERE, "ERROR PROPERTY");
            } else {
                inicializarLog();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    private static void traerArchivo() throws Exception {
        ...
        try {
            ...
            ftpClient.connect(server, port);                //ftp.edenor, 21
            ftpClient.login(user, pass);                    //cat_prod, 3d3n0r535
