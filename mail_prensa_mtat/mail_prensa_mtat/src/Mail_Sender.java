...
final class Mail_Sender {
	...
	try{
            ...
            //con_1= DriverManager.getConnection( "jdbc:oracle:thin:NEXUS_ENRE/NEXUS_ENRE@nexdbde01.pro.edenor:1521:GISDEV01");
            //con_1= DriverManager.getConnection( "jdbc:oracle:thin:NEXUS_ENRE/NEXUS_ENRE@tdbs6.tro.edenor:1521:GISDEV01");
            con_1= DriverManager.getConnection( "jdbc:oracle:thin:@ltronxgisbdpr03.pro.edenor:1528:GISPR03", "SVC_ORA_GIS", "jv506uzy" );
		...
		try{		    
			...
			enviarMail = true;
                        ...
                        if (true) {
                            ...
                            hst_Mail.put("PARA"      , "centrodeinformacion@edenor.com,ITSM_Desarrollos_propios@edenor.com");			
                            hst_Mail.put("ASUNTO"    , "Información sobre situación de documentos MTAT informados al ENRE");                        
                        } else {
                            hst_Mail.put("mailHost"  , "mail.edenor");
                            hst_Mail.put("DE"        , "centrodeinformacion@edenor.com");			
                            hst_Mail.put("PARA"      , "darbelo@edenor.com, rsleiva@edenor.com, vdiciurcio@edenor.com");			
                            hst_Mail.put("ASUNTO"    , "Información sobre situación de documentos MTAT informados al ENRE");                        
                        }
